...
public class BuildingSearchBuilder {// builder pattern dùng để giảm thiểu tham số khi truyền vào
    // và build những cái thứ ta cần search nên ko cần để trong dto(hoặc gọi là dto con)
    private String name;
    ...
    public static class Builder{ // đây là inner class vì có static dùng để build nhỏ đối tượng
        private String name;
        private String district;
        private String buildingArea;
        private String numberOfBasement;
        ...
        public BuildingSearchBuilder build(){
            return new BuildingSearchBuilder(this); // this ở đây chính là Builder
        }
    }
}
